              ...
              result => {
                ...
                for (let i = 0; i < this.candidatePositionsFromUser.length; i++) {
                  if(this.userToAvalue.id == this.candidatePositionsFromUser[i].candidate.id){
                    this.candidatePositionsFromUser[i].registry_date = (this.candidatePositionsFromUser[i].registry_date != null) || (this.candidatePositionsFromUser[i].registry_date != undefined) ? this.candidatePositionsFromUser[i].registry_date.substring(0, 10) + ' ' + (parseInt(this.candidatePositionsFromUser[i].registry_date.substring(11, 13)) + 2).toString() + this.candidatePositionsFromUser[i].registry_date.substring(13, 16) : ''
                      parseInt(this.candidatePositionsFromUser[i].registry_date.substring(11, 13)) + 2
